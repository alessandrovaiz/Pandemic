...
CREATE TABLE USERS (ID_USR SERIAL NOT NULL, EMA_USR varchar(80) NOT NULL UNIQUE, PAS_USR varchar(100) NOT NULL, PER_USR int4 DEFAULT 1 NOT NULL, ID_PER int4 NOT NULL, PRIMARY KEY (ID_USR));
